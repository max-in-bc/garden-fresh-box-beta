	...
	<div class="body_div">
		...
		<div class="row">
			...
			<div id="mainContent" class="col-sm-10">
				<div id="dashboard" style="display: none;" class="col-sm-2">
					<h2>User Tools</h2>

					<div class="btn-group btn-group-justified" role="group" aria-label="...">
						<div class="col-sm-3">
						<div class="btn-group" role="group">
							<button id="changepasswordButton" type="button" style="height:200px;width:230px;margin-bottom:4px;white-space:normal;background-color:rgba(232,228,218,0.3);" class="btn btn-default">
								<h4>Change password</h4>
								<ul class="text-left">
									<li>Change your current password to a new password</li>
								</ul>
							</button>
						</div>
						</div>
						...
						<div class="col-sm-3">
						<div class="btn-group" role="group">
							<button id="editprofileButton" type="button" style="height:200px;width:230px;margin-bottom:4px;white-space:normal;background-color:rgba(232,228,218,0.3);" class="btn btn-default">
								<h4>Edit personal information</h4>
								<ul class="text-left">
									<li>Change account contact information</li>
									<li>Add, edit, or update payment info</li><br>
								</ul>
							</button>
						</div>
						</div>
					</div> <!-- close user site button group -->
