...
<html lang="en">
	...
	<head>
		...
		<title>Garden Fresh Box - Contact Us</title><link rel="shortcut icon" href="images/gfb.ico" type="image/x-icon"/ >
			...
			<div class="row">
				...
				<div id="mainContent" class="col-sm-10">
					...
					<div class="content">
						...
						<a href="http://www.guelphchc.ca/">
							<img src="../images/GCHC.jpg">
						</a>
					</div>
				</div>
