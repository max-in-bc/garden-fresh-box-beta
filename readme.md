...
- Manage accounts of users who have signed up; may also be used to assign administrator or host site priveledges
- Manage complete order list (all host sites)
- See orders by host site, if a host site is selected it will open up a page listing all orders for that host site

**View complete donation list**
- Lists all donations by users and non-users

**View complete customer list**
- List all customers who have purchased boxes, if a user is selected then list his/her orders.
Existing orders can be edited as well.

**Manage the pickup dates for boxes**
- Manage the pickup dates that are used with forms throughout the site, as well as listed on the info page

**Manage sample boxes that appear on info page**
- Manage the example boxes that are listed on the info page
