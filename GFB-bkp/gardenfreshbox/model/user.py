...
class User():
	...
	def toTable(users):
		...
		tableStr = "<table class=\"table table-hover\" id=\"usersTable\" style=\"background-color:white;\"><thead><tr id=\"info\"><th>First Name</th><th>Last Name</th><th>Phone</th><th>Email</th><th>Host Site</th><th>Role</th></tr></thread><tbody>"
		...
		for user in users:
			...
			tableStr += "<td>" + str(user.get('host_site')) + "</td>"
