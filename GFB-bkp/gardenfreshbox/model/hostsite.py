...
class HostSite():
	...
	def __init__(self, name, address, city, province, postalCode, hoursOfOperation, phone):
	...
	def toTable(hs):
		...
		tableStr = "<table class=\"table table-hover\" id=\"hsTable\" style=\"background-color:white;\"><thead><tr id=\"info\"><th>Name</th><th>Phone</th><th>Hours</th><th>Address</th></tr></thread><tbody>"
		...
		for site in hs:
			...
			tableStr += "<td>" + str(site.get('address')) + ", " + str(site.get('city')) + ", " + str(site.get('province')) + ", " + str(site.get('postal_code')) + "</td></tr>"
